...
import com.example.a10_26_2019_loginpage.concierge.dataProcessor.requestHistoryDataProcessor;
...
public class ConciergeHistoryActivity extends AppCompatActivity {

    @Override
    public void onBackPressed() {
        DataSingleton singleton = DataSingleton.getInstance();
        singleton.destroy();
        Intent registerIntent = new Intent(ConciergeHistoryActivity.this, MainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_concierge_history);
        ...
        expListView = (ExpandableListView) findViewById(R.id.conciergeHistoryFrameExpendable);
        ...
        requestHistoryDataProcessor.fetchClosedRequests(requestList, ConciergeHistoryActivity.this);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch(menuItem.getItemId()){
                    case R.id.barMainFrame:
                        registerIntent = new Intent(ConciergeHistoryActivity.this, ConciergeMainActivity.class);
                        startActivity(registerIntent);
                        overridePendingTransition(0, 0);
                        break;
                    case R.id.barDeliveryFrame:
                        registerIntent = new Intent(ConciergeHistoryActivity.this, ConciergeDeliveryActivity.class);
                        startActivity(registerIntent);
                        overridePendingTransition(0, 0);
                        break;
                    case R.id.barSupportFrame:
                        registerIntent = new Intent(ConciergeHistoryActivity.this, ConciergeSupportActivity.class);
                        startActivity(registerIntent);
                        overridePendingTransition(0, 0);
                        break;
